...
const styles = StyleSheet.create({
    container: {
        flex: 1, padding: 100, backgroundColor: '#f8f8f8', width: '100%',
    },
    titulo: {
    ...
    modalBoton: {
        backgroundColor: '#000000', padding: 10, borderRadius: 5, elevation: 2, alignSelf: 'center', marginTop: 20,
    },
    modalBotonText: {
        fontSize: 16,
    },
    buscador: {
        height: 40, borderColor: 'gray', borderWidth: 1, marginBottom: 20, padding: 10, borderRadius: 5,
    },
});
