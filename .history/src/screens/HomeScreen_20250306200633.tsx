    ...
    useEffect(() => {
      const cargarPokemones = async () => {
          ...
          try {
              ...
              if (storagePokemones) {
                console.log('si hay de local', storagePokemones);
              ...
              // Si no hay datos en AsyncStorage, cargar desde la API
              const respuesta = await fetch('https://pokeapi.co/api/v2/pokemon?limit=100');
              if (!respuesta.ok) {
              ...
              // Guarda los datos en AsyncStorage para uso futuro
