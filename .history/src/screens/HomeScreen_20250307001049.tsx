    ...
    return (
        <View style={styles.container}>
          ...
          <TouchableOpacity
              ...
              onPress={() => cargarPokemones(offset)}
          >
...
const styles = StyleSheet.create({
  ...
  reloadButton: {
    position: 'absolute', alignContent:'center', bottom: 20, backgroundColor: '#28a745', padding: 15, borderRadius: 30, elevation: 5, justifyContent: 'center', width: '100%',
  },
  reloadButtonText: {
    color: '#fff', fontSize: 16, textAlign: 'center',
  },
